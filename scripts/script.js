...
watch420[4]= "/watch/subbat(black_blue).png";
watch420[5]= "/watch/subblack.png";
watch420[6]= "/watch/subblue.png";
watch420[7]= "/watch/subcola (blue_red).png";
watch420[8]= "/watch/sublantern(green).png";
...
function generateMfers(mfers, seedinput) {
	...
	html2canvas(document.getElementsByClassName("html-content-holder")[0],{allowTaint: true,useCORS: true, imageTimeout: 5000}).then(function (canvas) {
